...
export default function Inspections() {
  ...
  const loadInspections = useCallback(async () => {
    ...
    try {
      ...
      const data = await getLandlordInspections(user.uid);

      setInspections(data || []);
    } catch (err) {
      console.error("Error loading landlord inspections:", err);
            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  Manage property inspection requests from tenants.
                </p>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-emerald-700 dark:text-emerald-400">
                      This will notify the tenant and give them a 24-hour window
                      to confirm the inspection was completed.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {isPaymentPending && (
            <div className="mt-4 rounded-xl border border-orange-200 bg-orange-50 p-4 text-sm text-orange-800 dark:border-orange-900/40 dark:bg-orange-950/20 dark:text-orange-300">
              ...
              <p className="mt-1">
                ...
                inspection fee before the inspection becomes confirmed.
              </p>
            </div>
          )}
          ...
          {isCompletionPending && (
            <div className="mt-4 rounded-xl border border-purple-200 bg-purple-50 p-4 text-sm text-purple-800 dark:border-purple-900/40 dark:bg-purple-950/20 dark:text-purple-300">
              ...
              {tenantAlreadyConfirmed ? (
                ...
                <p className="mt-1">
                  You have confirmed completion. The inspection is waiting for
                  the tenant to confirm.
                </p>
              ) : (
                <p className="mt-1">
      ...
      {inspection.completionConfirmationDeadline && (
        <div className="rounded-xl bg-purple-50 p-4 dark:bg-purple-950/30">
          ...
          <div className="mt-3 space-y-1 text-sm">
            <p>
              <strong>Manager confirmed:</strong>{" "}
